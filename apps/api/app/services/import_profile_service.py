...
def create_import_profile(
    ...
    db_profile = FileImportProfile(
        ...
        amount_schema=profile_data.amount_schema,
        transaction_type_detection=profile_data.transaction_type_detection,
        positive_is_income=profile_data.positive_is_income,
        debit_column_is_expense=profile_data.debit_column_is_expense,
