...
Revision ID: 1da0675abd0b
Revises: 86663b5c5721
Create Date: 2025-06-25 07:41:39.297174
...
revision: str = '1da0675abd0b'
down_revision: Union[str, None] = '86663b5c5721'
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['bank_id'], ['app.banks.id'], ),
    ...
    op.create_table('user_financial_methods',
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('financial_method_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['financial_method_id'], ['app.financial_methods.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['app.users.id'], ),
    sa.PrimaryKeyConstraint('user_id', 'financial_method_id'),
    schema='app'
    )
...
def downgrade() -> None:
    ...
    op.drop_table('user_financial_methods', schema='app')
