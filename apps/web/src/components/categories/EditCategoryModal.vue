          ...
          <div>
            ...
            <div class="mt-1 flex items-center space-x-2">
              <input
                ...
                maxlength="2"
              />
              <div class="text-xl">{{ form.icon || "🏷️" }}</div>
            </div>
...
function initializeForm() {
  ...
  form.isIncome = props.category.isIncome;
  form.displayOrder = props.category.displayOrder;
}
...
async function updateCategory() {
  ...
  try {
    await categoryService.update(props.category.id, {
      name: form.name.trim(),
    ...
    error.value =
      err instanceof Error ? err.message : "Error actualizando categoría";
